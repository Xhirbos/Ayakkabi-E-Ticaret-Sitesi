...
// Reddedilen mağaza başvurularını getir
$query = "SELECT m.*, p.ad, p.soyad 
         FROM magaza m 
         LEFT JOIN personel p ON m.personelID = p.personelID
         WHERE m.basvuruDurumu = 'Reddedildi'
         ORDER BY m.kayitTarihi DESC";
$result = $conn->query($query);
?>
<div class="content-wrapper">
<div class="page-header">
    <h1 class="page-title">Reddedilen Mağaza Başvuruları</h1>
        ...
        <div class="table-responsive">
            <table class="table table-striped datatable">
                ...
                <tbody>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <p><strong>Durum:</strong> <span class="badge bg-danger">Reddedildi</span></p>
                                                </div>
                                            </div>
                                            
                                            <?php if (!empty($magaza['redNedeni'])): ?>
                                                <div class="mt-3">
                                                    <h6>Ret Nedeni:</h6>
                                                    <div class="alert alert-danger">
                                                        <?php echo nl2br($magaza['redNedeni']); ?>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="8" class="text-center">Reddedilen mağaza başvurusu bulunamadı.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
